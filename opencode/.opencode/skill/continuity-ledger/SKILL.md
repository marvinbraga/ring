...
metadata:
  trigger: "Before running /clear, context at 70%+, multi-phase implementations"
  skip_when: "Quick tasks (< 30 min), simple bug fixes, already using handoffs"
  source: ring-default
---
...
|-----------------|----------------|-----------------|
| "I'll update after I finish" | You'll forget. State drifts. | **Update NOW** |
| "It's just one phase" | One phase becomes three. Ledger shows Phase 2 when you're on Phase 5. | **Update NOW** |
| "User will ask me to update" | User shouldn't have to. You're doing the work. | **Update NOW** |
