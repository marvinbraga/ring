...
2. **ALWAYS use `--trailer` parameter for AI identification:**
   ...
   - Trailers go in the git command, NOT in the message text
...
# WRONG - Co-Authored-By in message
git commit -m "feat: add feature

Co-Authored-By: Claude <noreply@anthropic.com>"

# WRONG - HEREDOC with signature
...
```bash
# CORRECT - clean message with trailers via parameter
git commit \
  -m "feat: add feature" \
  --trailer "Generated-by: Claude" \
  --trailer "AI-Model: claude-opus-4-5-20251101"
