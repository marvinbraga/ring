...
2. **Select agent:** Go → `ring-dev-team:backend-engineer-golang` | TS backend → `ring-dev-team:backend-engineer-typescript` | React/Frontend → `ring-dev-team:frontend-bff-engineer-typescript` | Infra → `ring-dev-team:devops-engineer`
