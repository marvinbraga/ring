...
2. **Skills** – `Skill tool: "skill-name"`
3. **Agents** – `Task tool with subagent_type: "agent-name"`

---

## 📋 Slash Commands

All commands prefixed with `/` for default plugin commands.
Other plugins require full prefix: `/`, `/`, `/`, `/`, `/`, `/`, `/`, `/`.
