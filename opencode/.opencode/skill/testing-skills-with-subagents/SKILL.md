...
metadata:
  trigger: "Before deploying new skill, after editing skill, skill enforces discipline"
  skip_when: "Pure reference skill, no rules that agents have incentive to bypass"
  source: ring-default
---
