...
metadata:
  trigger: "Need to find similar past work, learn from previous work, looking for historical context"
  skip_when: "Novel functionality, simple task, artifact index not initialized"
