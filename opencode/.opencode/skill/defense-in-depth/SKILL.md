...
metadata:
  trigger: "Bug caused by invalid data reaching deep layers, single validation can be bypassed"
  skip_when: "Validation already exists at all layers, simple input validation sufficient"
  source: ring-default
---
