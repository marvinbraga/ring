...
**You MUST systematically compare EVERY section from the WebFetch result (golang.md or typescript.md) with the codebase-report.md.**

**Process:**
1. **Parse the WebFetch result** - Identify ALL testing-related sections
