    ...
    cat <<'EOF'
{
  "hookSpecificOutput": {
    "hookEventName": "SessionStart",
    "additionalContext": "<ring-dev-team-system>\n**Developer Specialists Available**\n\nUse via Task tool with `subagent_type`:\n\n**Backend Engineers:**\n| Agent | Expertise |\n|-------|----------|\n| `backend-engineer-golang` | Senior Backend Engineer specialized in Go for high-demand financial systems. |\n| `backend-engineer-typescript` | Senior Backend Engineer specialized in TypeScript/Node.js for scalable systems. |\n\n**Frontend Engineers:**\n| Agent | Expertise |\n|-------|----------|\n| `frontend-designer` | Senior Frontend Designer specialized in creating distinctive, production-grade interfaces with high design quality that avoid generic AI aesthetics. |\n| `frontend-engineer-typescript` | Senior Frontend Engineer specialized in TypeScript-first React/Next.js development. |\n\n**Infrastructure & Quality:**\n| Agent | Expertise |\n|-------|----------|\n| `devops-engineer` | Senior DevOps Engineer specialized in cloud infrastructure for financial services. |\n| `qa-analyst` | Senior Quality Assurance Analyst specialized in testing financial systems. |\n| `sre` | Senior Site Reliability Engineer specialized in high-availability financial systems. |\n\nFor full details: Skill tool with \"ring-dev-team:using-dev-team\"\n</ring-dev-team-system>"
  }
}
EOF
  fi
