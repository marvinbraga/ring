...
**You MUST systematically compare EVERY section from the WebFetch result (devops.md) with the codebase-report.md.**

**Process:**
1. **Parse the WebFetch result** - Identify ALL sections in devops.md
