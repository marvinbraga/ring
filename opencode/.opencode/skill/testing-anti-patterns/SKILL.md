...
metadata:
  trigger: "Reviewing/modifying existing tests, adding mocks, tempted to add test-only methods"
  skip_when: "Writing new tests via TDD, pure unit tests without mocks"
  source: ring-default
---
